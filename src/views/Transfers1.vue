<template>
  <div class="transfers">
    ...
    <div class="banner-container">
      <img :src="banner" alt="接送横幅" class="banner" />
    ...
    <div class="intro">
      <h1>迪拜私人接送 — 轻松抵达</h1>
      <p>以舒适与便捷开启您的迪拜旅程。万德假日（WanderWonderWorld）为您提供口碑优选的私人接送与含司机用车服务，车队整洁保养到位，资深司机熟悉阿联酋道路。无论是无忧的机场接送，还是个性化城市观光与商务行程，我们都以专业、顺畅的服务，贴合您的出行心愿。</p>
    </div>
...
<div class="faq-card">
  ...
  <div v-for="(faq, index) in faqs" :key="index" class="faq-item">
    ...
    <div class="text-card">
      <h2>顺畅出行：我们的迪拜司导服务</h2>
      <p>万德假日为您提供专业可靠的司导服务，专注舒适与安心。我们的车辆整洁保养良好，由持证且经验丰富的司机运营；从高效的机场接送到按需定制的一日行程，确保安全省心的出行体验。我们始终重视准点守时、车辆安全与优质服务。</p>
    </div>

    <div class="text-card">
      <h2>量身定制：私人用车与司机选择</h2>
      <p><strong>机场接送：</strong> 提供迪拜（DXB）与阿布扎比（AUH）机场至两地任意目的地的准点迎送服务，司机实时关注航班动态，航班延误亦可及时衔接。</p>
      <p><strong>半日/全日包车：</strong> 以小时或天为单位的司导服务，自由安排行程节奏，适用于城市观光、商务会议或家庭出游。</p>
      <p><strong>安全与舒适：</strong> 车辆行李空间充足；如需儿童座椅，请提前告知，我们将为您的家庭出行提供更周到的保障。</p>
      <p><strong>价格说明：</strong> 价格根据车型与用车时长透明计费；欢迎联系我们，根据您的具体计划提供详细报价。</p>
    </div>

    <div class="text-card">
      <h2>预订条款与细则</h2>
      <p><strong>服务名额：</strong> 所有服务以车辆与司机当日可用为准，建议提前预订以确保心仪日期与车型。</p>
      <p><strong>车辆使用：</strong> 司导服务适用于私人接送与日间观光；车内禁止饮食与吸烟。</p>
      <p><strong>取消政策：</strong> 取消需遵循预订政策以避免费用；具体条款将在预订时告知。</p>
      <p><strong>未到场（No-Show）：</strong> 如到约定上车点迟到且未事先通知，可能视为未到场并产生相应费用。</p>
      <p><strong>超时计费：</strong> 行程加时将按车型与原预订时长另行计费。</p>
      <p><strong>旺季附加费：</strong> 特定日期可能收取旺季附加费，预订时将明确说明。</p>
      <p><strong>导游说明：</strong> 司机并非持证导游，如需持证中文或英文导游，可按需另行安排并收取相应费用。</p>
    </div>

    <div class="text-card">
      <h2>万德假日的目的地服务</h2>
      <p>作为迪拜持牌目的地管理公司（DMC），万德假日提供覆盖面广的旅游与交通解决方案。我们的含司机用车服务贯穿机场接送、城市观光、商务会务与家庭休闲行程，旨在为您带来专业顺畅的体验。</p>
      <p>我们提供多样车型选择，包括豪华轿车、家庭宽体商务车与舒适旅游巴士；所有车辆均由专业司机全程协助。若涉及团体预订或复杂行程，我们的团队可为您定制与您愿景高度匹配的专属方案。</p>
    </div>
  </div>
</template>
