<template>
  <div class="safari">
    ...
    <div class="banner-container">
      <img :src="banner" alt="产品横幅" class="banner" />
      <div class="floating-logos">
        <img :src="logoGold" alt="金色徽标" class="logo" />
        <img :src="logoText" alt="文字徽标" class="logo-text" />
      </div>
    </div>
      ...
      <table class="price-table">
        ...
        <tbody>
          <tr>
            <td>迪拜溪传统独桅帆船晚餐</td>
            <td>90–120 分钟</td>
            <td><strong style="color:#b01b1b;">成人 AED 85 | 儿童 AED 70</strong></td>
          </tr>
          <tr>
            <td>迪拜码头独桅帆船晚餐</td>
            <td>2 小时</td>
            <td><strong style="color:#b01b1b;">成人 AED 115 | 儿童 AED 95</strong></td>
          </tr>
          <tr>
            <td>水道玻璃游船晚餐</td>
            <td>约 2 小时</td>
            <td><strong style="color:#b01b1b;">成人 AED 149 | 儿童 AED 119</strong></td>
          </tr>
          <tr>
            <td>Lotus 巨型游艇晚餐</td>
            <td>3 小时</td>
            <td><strong style="color:#b01b1b;">成人 AED 239 | 儿童 AED 189</strong></td>
          </tr>
        </tbody>
      </table>
    ...
    <div v-if="showEmailToast" class="center-toast" role="status" aria-live="polite">
      <div class="center-toast-box">
        <p><strong>info@wanderwonderworlddubai.com</strong> 已复制到剪贴板</p>
      </div>
    </div>
    ...
    <!-- Copy blocks -->
    <div class="text-card">
      <h2>水上良宵，从这里挑选：航线总览</h2>
      <p><strong>迪拜河传统木船晚宴：</strong>乘坐阿拉伯多乌木船（Dhow），欣赏老迪拜天际线；国际自助晚餐，含瓶装水/软饮；按规定开放时有 <em>Tanoura</em> 民俗表演。亲民价位、氛围轻松。可付费锁定<em>上层甲板</em>或<em>靠窗座</em>，加购登船前老城迷你步行＋阿布拉小船，或私家酒店接送。</p>
      <p><strong>迪拜码头 Marina 木船晚宴：</strong>人气夜景航线——Marina、JBR 与 Bluewaters 一线尽收眼底。船型可能为传统木船或现代玻璃船（由运营方安排）。含自助晚餐与软饮，按规定开放文娱。可选上层/靠窗座位与生日/纪念日桌面布置。</p>
      <p><strong>迪拜水运河玻璃游船晚宴：</strong>高端玻璃全景船，途经水运河与商务湾桥群，大片落地视野，安静而带“轻法餐”氛围；有机会优先安排窗景位（以当日情况为准）。可加购登船前速览 Dubai Frame 门票。</p>
      <p><strong>Lotus 超级游艇晚宴：</strong>畅游 3 小时，迪拜大型游艇之一；现场 DJ、多层甲板、开放式料理台与休闲沙发区。可选 VIP 沙发区；在许可日期可加购 Premium Drinks 酒水套餐。</p>
    </div>

    <div class="text-card">
      <h2>条款与细则（游船晚宴）</h2>
      <p><strong>登船与时间：</strong>标准航线（河/码头/水运河）20:00 登船、20:30 开航，航行约 90–120 分钟。Lotus 超级游艇 19:00 报到，19:30–22:30 航行。迟到将视作未到场，由船方认定。</p>
      <p><strong>费用包含：</strong>仅门票包含船上座位、自助晚餐（清真；可选素/荤；耆那/纯素需提前告知）、瓶装水/软饮，以及在允许时段的演出。含税。酒精饮品仅在持牌船只与非斋月/非禁酒日提供。</p>
      <p><strong>接送服务：</strong>酒店私家往返接送可按价目表加购。可按需免费提供儿童/增高座椅（数量有限）。车辆内禁止饮食与吸烟。</p>
      <p><strong>座位安排：</strong>先到先得或由运营方统筹。付费升级保证区域（上层/靠窗/VIP），不保证具体桌号。同行家庭尽量安排同桌。</p>
      <p><strong>天气/航线：</strong>海事管控、风力或水路交通可能调整航线/泊位（如运河瀑布临时关闭）。如运营方取消，可改期或全额退款；若仅变更航线但照常航行，则不予退款。</p>
      <p><strong>改期与取消：</strong>河/码头/运河：≥24 小时免费；12–24 小时收 50%；&lt;12 小时或未到场收 100%。Lotus/VIP：≥48 小时免费；24–48 小时收 50%；&lt;24 小时收 100%。节庆夜（跨年/国庆/大型活动）条款更严且可能加价。</p>
      <p><strong>合规与安全：</strong>船只持 DMCA/RTA 执照，配备救生衣与专业船员；接送车辆已投保并由 RTA 持证司机驾驶。</p>
    </div>
