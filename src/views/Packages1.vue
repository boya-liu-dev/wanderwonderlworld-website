      ...
      <table class="price-table">
        ...
        <tbody>
          <tr>
            <td>迪拜3晚入门之旅</td>
            <td>4天</td>
            <td><strong style="color:#b01b1b;">成人 AED 849 | 儿童 AED 669</strong></td>
          </tr>
          <tr>
            <td>4晚亲子优选</td>
            <td>5天</td>
            <td><strong style="color:#b01b1b;">成人 AED 1099 | 儿童 AED 919</strong></td>
          </tr>
          <tr>
            <td>迪拜 + 阿布扎比5晚精华</td>
            <td>6天</td>
            <td><strong style="color:#b01b1b;">成人 AED 1349 | 儿童 AED 1169</strong></td>
          </tr>
          <tr>
            <td>6晚臻选升级</td>
            <td>7天</td>
            <td><strong style="color:#b01b1b;">成人 AED 1599 | 儿童 AED 1419</strong></td>
          </tr>
        </tbody>
      </table>
