<template>
  <div class="home">
    ...
    <div class="banner-container">
      <img :src="bannerImages[currentIndex]" alt="横幅" class="banner" />
      <!-- Floating logos -->
    ...
    <h2>万德假日，欢迎您访问 WanderWonderWorldDubai.com</h2>
    <p class="slogan">您的旅程，我们的热爱。</p>
    ...
    <div class="intro-text">
      ...
      <div class="news-trust-grid">
        ...
        <section class="trust-col">
          <section class="trust">
            <h3 class="trust-title">您在迪拜值得信赖的行程专家</h3>
      ...
      <!-- Private Transfers -->
      <h3 class="section-title">私人接送</h3>
      ...
      <!-- Tour Packages -->
      <h3 class="section-title">精选行程套餐</h3>
      <div class="cards-container">
        <CarCard
          :image="tp1"
          title="迪拜3晚入门之旅"
      ...
      <!-- Desert Safari -->
      <h3 class="section-title">沙漠探险</h3>
      <div class="cards-container">
        <CarCard
          :image="sf1"
          title="晨曦沙丘越野"
      ...
      <!-- City Tour -->
      <h3 class="section-title">城市观光</h3>
      <div class="cards-container">
        <CarCard
          :image="ct1"
          title="半日迪拜精华"
      ...
      <!-- Dhow Cruise -->
      <h3 class="section-title">游船晚宴</h3>
      <div class="cards-container">
        <CarCard
          :image="dc1"
          title="迪拜溪传统独桅帆船晚餐"
      ...
      <!-- 文本卡片：网站使用流程（全英文） -->
      <div class="text-card">
        <h2>如何使用万德假日（WanderWonderWorld）— 简洁清晰</h2>
        <ol class="process-list">
          <li><strong>浏览</strong> 上方各栏目：私人接送、行程套餐、沙漠探险、城市观光或游船晚宴。</li>
          <li><strong>加入万德购物车</strong> 点击“加入万德购物车”或“立即预订”，将心仪服务加入清单。</li>
          <li><strong>打开万德购物车</strong> 填写姓名、邮箱、出行日期与简要需求说明；支持一次提交多项服务。</li>
          <li><strong>提交</strong> — 我们会在 <em>3个工作日</em> 内邮件回复。需要更快？请通过
          ...
          <li><strong>确认</strong> — 确认后您将收到行程单与上车详情；服务前 24 小时我们会通过 WhatsApp 再次确认。</li>
        </ol>
      </div>
